...
//				    break;
				...
				case 14:
					...
					try {
						...
						genereServiceInstance.delete(idG14);
				...
				case 16:
				    ...
				    System.out.println("Inserisci la prima data dell'intervallo [dd.MM.yyyy]:");
				    String dataInizioString = scanner.nextLine();
				    System.out.println("Inserisci la seconda data dell'intervallo [dd.MM.yyyy]:");
				    String dataFineString = scanner.nextLine();
				    try {
				        DateTimeFormatter formatter = DateTimeFormatter.ofPattern("dd.MM.yyyy");
				        LocalDate dataInizio = LocalDate.parse(dataInizioString, formatter);
				        LocalDate dataFine = LocalDate.parse(dataFineString, formatter);
				        ...
				        System.out.println("Formato della data non valido, usa il formato dd-MM-yyyy.");
				    } catch (Exception e) {
				        System.out.println("Si è verificato un errore: " + e.getMessage());
				        e.printStackTrace();
				    }
