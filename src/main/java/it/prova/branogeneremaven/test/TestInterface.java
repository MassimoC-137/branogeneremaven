		...
		while (!exit) {
	        ...
	        try {
				...
				case 2:
					...
					try {
						Long idB2 = Long.parseLong(scanner.nextLine());
				...
				case 3:
					...
					try {
						...
						String dataPubblicazioneB3 = scanner.nextLine();
						LocalDate dataB3 = null;
						try {
						    DateTimeFormatter formatter = DateTimeFormatter.ofPattern("dd.MM.yyyy"); 
						    dataB3 = LocalDate.parse(dataPubblicazioneB3, formatter);
						    System.out.println("Data di pubblicazione valida: " + dataB3);
						} catch (DateTimeParseException e) {
						    System.out.println("La data inserita non è valida, usa il formato dd.MM.yyyy");
						}
						...
						nuovoBrano.setTitolo(titoloB3);
						nuovoBrano.setAutore(autoreB3);
						nuovoBrano.setDataPubblicazione(dataB3);
				...
				case 4:
					...
					try {
						...
						String titoloB4 = scanner.nextLine();

						System.out.println("Inserisci l'autore del brano:");
						String autoreB4 = scanner.nextLine();
				        ...
				        Brano nuovoBrano = new Brano();
						nuovoBrano.setTitolo(titoloB4);
						nuovoBrano.setAutore(autoreB4);
						nuovoBrano.setDataPubblicazione(dataB4);
				        nuovoBrano.setGeneri(generi);
